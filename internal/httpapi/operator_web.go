...
func WithOperatorWeb() Option {
	return func(s *Server) {
		...
		s.mux.HandleFunc("GET /phase4.css", serveOperatorAssetBundle([]string{"phase4.css", "tablet-controller.css", "tablet-authoring.css", "visual-engine.css", "assistant-workspace.css"}, "text/css; charset=utf-8"))
		...
		s.mux.HandleFunc("GET /timecode.js", serveOperatorAsset("timecode.js", "application/javascript; charset=utf-8", false))
		s.mux.HandleFunc("GET /timing-intelligence.js", serveOperatorAsset("timing-intelligence.js", "application/javascript; charset=utf-8", false))
		...
		s.mux.HandleFunc("GET /phase4.js", serveOperatorAssetBundle([]string{"phase4.js", "tablet-controller.js", "tablet-authoring.js", "visual-engine.js", "assistant-workspace.js"}, "application/javascript; charset=utf-8"))
