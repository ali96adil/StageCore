...
func WithOperatorWeb() Option {
	return func(s *Server) {
		...
		s.mux.HandleFunc("GET /phase4.css", serveOperatorAssetBundle([]string{"phase4.css", "tablet-controller.css", "tablet-authoring.css"}, "text/css; charset=utf-8"))
		...
		s.mux.HandleFunc("GET /phase4.js", serveOperatorAssetBundle([]string{"phase4.js", "tablet-controller.js", "tablet-authoring.js"}, "application/javascript; charset=utf-8"))
