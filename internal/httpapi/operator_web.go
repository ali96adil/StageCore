...
func WithOperatorWeb() Option {
	return func(s *Server) {
		...
		s.mux.HandleFunc("GET /execution-environments.js", serveOperatorAssetBundle([]string{"execution-environments.js", "execution-environments-workspace.js"}, "application/javascript; charset=utf-8"))
	}
}
