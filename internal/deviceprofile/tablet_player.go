...
func tabletPlayerProfile() Profile {
	...
	return Profile{
		...
		Summary: LocalizedText{
			EN:   "Authenticated Android stage-media endpoint using the StageCore device channel (v1/v2).",
		...
		Capabilities: []Capability{
			...
			{Key: "tablet.media.live.show", Name: LocalizedText{EN: "Show live source", ArIQ: "إظهار البث المباشر"}, Actions: []Action{{ID: "show", Name: LocalizedText{EN: "Show live", ArIQ: "إظهار البث"}, ParameterSchema: json.RawMessage(`{"type":"object","properties":{"media_key":{"type":"string","minLength":1,"maxLength":256},"url":{"type":"string","minLength":1,"maxLength":2048,"pattern":"^https?://"}},"oneOf":[{"required":["media_key"]},{"required":["url"]}],"additionalProperties":false}`)}}},
