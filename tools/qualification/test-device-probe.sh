...
python3 "$REPO_ROOT/tools/qualification/assert-device-probe.py" --input "$probe" --kind tablet --project-id project-1 --device-id tablet-01
python3 "$REPO_ROOT/tools/qualification/assert-device-probe.py" --input "$probe" --kind lighting --project-id project-1 --device-id lighting-01
