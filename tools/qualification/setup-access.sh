...
ensure_key STAGECORE_TABLET_EXPECT_ON unknown
ensure_key STAGECORE_LIGHTING_EXPECT_ON unknown
...
ensure_key STAGECORE_TABLET_QUALIFICATION_GROUP
ensure_key STAGECORE_DRAFT_QUALIFICATION_PROJECT_ID
ensure_key STAGECORE_CALLBOARD_DEVICE_ID
ensure_key STAGECORE_NETWORK_QUALIFICATION_DEVICE_ID
ensure_key STAGECORE_CALLBOARD_QUALIFICATION_CUE_NAME
ensure_key STAGECORE_QUALIFICATION_NONOWNER_CREDENTIAL_FILE
