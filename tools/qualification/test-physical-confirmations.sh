...
for spec in   "Q-TAB-06 prepare.command" "Q-TAB-06 play.command"   "Q-DMX-03 set.command"   "Q-DMX-04 multi_set.command"   "Q-DMX-05 fade.command"   "Q-DMX-06 multi_fade.command"   "Q-DMX-10 blackout.command"   "Q-DMX-11 precondition_set.command" "Q-DMX-11 timed_blackout.command"; do
  set -- $spec
...
for gate in ("Q-TAB-06","Q-DMX-03","Q-DMX-04","Q-DMX-05","Q-DMX-06","Q-DMX-10","Q-DMX-11"):
    assert gate in ids
...
for gate in Q-TAB-06 Q-DMX-03 Q-DMX-04 Q-DMX-05 Q-DMX-10 Q-DMX-11; do
